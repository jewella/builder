...
sed -i "s/%PI_INSTALL_DOCKER_COMPOSE%/$PI_INSTALL_DOCKER_COMPOSE/g" "${ROOT_DIR}/first_run.sh"
sed -i "s/%PI_INSTALL_GIT%/$PI_INSTALL_GIT/g" "${ROOT_DIR}/first_run.sh"
...
sed -i "s/%PI_CAMERA%/$PI_CAMERA/g" "${ROOT_DIR}/first_run.sh"
